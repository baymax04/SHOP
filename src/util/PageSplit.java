...
public class PageSplit {	
	...
	private String p_size = "15";
	private String p_sort = "asc";

	/************以下是计算使用********/
	// 每页显示条数 默认数值
	private int size = Integer.parseInt(p_size);
	// 当前页数
	private int page = Integer.parseInt(p_page);
	// 总页数
	...
	public void build() {
		...
		// 计算总页数
		totalPage = this.totalCnt % size == 0 ? totalCnt / size : totalCnt / size + 1;
		// 当前页数不能大于总页数
